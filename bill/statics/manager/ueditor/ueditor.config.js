...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['source', 'undo', 'redo', 
                'bold', 'italic', 'underline', 'fontborder','autotypeset', 'blockquote','forecolor', 'removeformat', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', 'link', 'unlink', '|',
                'rowspacingtop', 'rowspacingbottom', 'lineheight', '|' ,'horizontal', 'date', 'time', 'gmap',
                ...
                ['preview', 'help', 'directionalityltr', 'directionalityrtl', 'indent', '|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
                'insertimage','attachment','customstyle', 'paragraph', 'fontfamily', 'fontsize',]
        ]
